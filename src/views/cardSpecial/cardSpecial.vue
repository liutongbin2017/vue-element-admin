<template>
  <div>
    ...
    <el-table :data="tableData" border style="width: 100%;margin-top:20px">
      <el-table-column prop="typeid" label="名称"> </el-table-column>
      <el-table-column prop="typeid" label="描述"> </el-table-column>
...
"
    ...
    <el-pagination style="text-align:center;margin-top:10px" layout="prev, pager, next" :total="1000"> </el-pagination>
...
<script>
module.exports = require('./cardSpecial.js')
</script>

<style lang="scss" scoped src="./cardSpecial.scss"></style>
